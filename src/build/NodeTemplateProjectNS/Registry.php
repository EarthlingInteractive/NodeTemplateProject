...
class NodeTemplateProjectNS_Registry
{
	...
	public function loadSchema($name='') {
		return require NodeTemplateProjectNS_ROOT_DIR.'/schema/'.($name?$name.'.':'').'schema.php';
	}
	...
	public function loadStorageHelper() {
		return new NodeTemplateProjectNS_NormalStorageHelper($this);
	}
	...
	protected function getBlobRepositoryDirs() {
		...
		array_unshift($repos, NodeTemplateProjectNS_ROOT_DIR.'/datastore');
		return $repos;
	}
	...
	protected function getViewTemplateDirectory() {
		return NodeTemplateProjectNS_ROOT_DIR.'/views';
	}
